...
/**
 * A {@code VoteInventory} is an inventory that can contain several voting
 * items. Note that the name of each voting option is case-insensitive.
 */
public class VoteInventory
{
	 ...
	 * @return {@code true} if the inventory has that option, {@code false} if
	 *         he doesn't.
	 */
	 ...
	 */
	public void removeVoteOption(String name) throws VotingOptionNotFoundException
	{
		if (hasVoteOption(name))
		{
		...
		{
			throw new VotingOptionNotFoundException("Vote option does not exist");
		}
	}

	/**
	 * Updates the item that represents a specific option and increases the
	 * number of votes it has.
	 * 
	 * @param option The voting option whose item should be updated.
	 * @param votesToAdd The number of votes to add to the item. Can be negative
	 *        for subtraction.
	 */
	...
	public void addVote(Player player, String option)
			throws VoteLimitReachedException, VoteAlreadyPlacedException, VotingOptionNotFoundException
	{
	 ...
	 */
	public void removeVote(Player player, String option) throws VoteNotPlacedException, VotingOptionNotFoundException
	{
		if (hasVoteOption(option))
		{
			Collection<String> votes = getVotesByPlayer(player);
	 ...
	 * @param player The player to check for.
	 * @param option The option to check for.
	 * @return {@code true} if the player has voted on it, {@code false} if the
	 *         player hasn't.
	 */
	 ...
	 * @param player The player to check for.
	 * @param option The option to check for.
	 * @return {@code true} if the player can vote on the option, {@code false}
	 *         if the player can't for any reason.
	 */
	 ...
	 * 
	 * @param item The voting item to check. If this is {@code null} it will
	 *        immediately return false.
	 * @param voteOption The name of the voting option to check against.
	 * @return {@code true} if the item represents the vote option,
